...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_style( 'aos-styles', get_template_directory_uri() . '/css/aos.css', array(), $css_version );

		wp_enqueue_script( 'jquery' );

		$js_version = $theme_version . '.' . filemtime( get_template_directory() . $theme_scripts );
		wp_enqueue_script( 'understrap-scripts', get_template_directory_uri() . $theme_scripts, array(), $js_version, true );
		wp_enqueue_script( 'aos-scripts', get_template_directory_uri() . '/js/aos.js', array(), $js_version, true );
		wp_enqueue_script( 'fellowship-scripts', get_template_directory_uri() . '/js/main.js', array(), $js_version, true );
